...
public class GraphToSMILES {
	 ...
	 * @return
	 */
	public static String getName( BitVector b){
		String name = "c";
	...
	/**
	 * Adds a value to the hash map. When two valuse hash to the same position, 
	 * they are added to the same list, rather than replace each other. This is
	 * because one node may be part of mulitple cycles
	 * @param b, bitvector
	 * @param number, number
	 */
